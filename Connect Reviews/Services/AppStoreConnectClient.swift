...
final class AppStoreConnectClient {
    ...
    init(
        ...
        self.useMockData = credentials.isAppleReviewDemoAccount
    }
    ...
    func fetchApps() async throws -> [AppResource] {
        ...
        let apps: [AppResource] = try await fetchAllPages(
    ...
    func fetchAppStoreVersions(appID: String) async throws -> [AppStoreVersionResource] {
        ...
        let versions: [AppStoreVersionResource] = try await fetchAllPages(
    ...
    func fetchITunesMetadata(
        ...
        return await fetchITunesLookupMetadata(
            appID: appID,
            bundleID: bundleID,
    ...
    func fetchVendorName(appID: String, bundleID: String) async -> String? {
        if useMockData {
            return mockITunesMetadata(appID: appID)?.sellerName
        }
    ...
    private func mockITunesMetadata(appID: String) -> ITunesMetadataResult? {
